...
namespace BitzBytez
{
    public partial class PurchaseHistory : System.Web.UI.Page
    {
        ...
        protected void ddl_orderID_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            ShippingAddress add = ShippingAddressDA.getShippingAddressFromOrder(int.Parse(ddl_orderID.SelectedValue));
            tbody_orderItems.InnerHtml +=
                    "<tr>" +
                    ...
                    +
                    "<tr>" +
                        "<td class=\"text-center\" colspan=\"3\" style=\"border-top: 2px dashed #C1C3D1; font-size:15px;\"><span style=\"font-weight: bold; font-style: italic;\">Shipped to: </span>" + add.AddressLine1 + " " + add.AddressLine2 + " " + add.City + " " + add.StateProvinceRegion + " " + add.Country + " " + add.PostalCode +
                    "</tr>"
                    ;
        }
    }
