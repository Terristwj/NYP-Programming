<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="CustomerProfile.aspx.cs" Inherits="BitzBytez.CustomerProfile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="background: white; padding-left: 0px; min-height:600px;">
        <div class="row">
            <div>
                <div class="sidebar left" style="min-height: 795px; font-size: 14px;">
                    <div class="user-panel">
                        ...
                        <div class="pull-left info">
                            <p>Welcome, </p>
                            <h4 style="letter-spacing:-1px;"><strong><span id="username" runat="server">Peter Tan</span></strong></h4>
                        </div>
                    </div>
                    <ul class="list-sidebar bg-defoult">
                        ...
                        <li>
                            <asp:LinkButton ID="btn_warrantyTracker" runat="server" OnClick="btn_warrantyTracker_Click"><i class="fa fa-clock-o"></i><span class="nav-label">&emsp;Warranty Tracker</span></asp:LinkButton>
                        </li>
                        <li>
                        ...
                        <li>
                            <asp:LinkButton ID="btn_LogOut" runat="server" OnClick="btn_LogOut_Click"><i class="fa fa-power-off"></i><span class="nav-label">&emsp;Log Out</span></asp:LinkButton>
                        </li>
