    ...
    public partial class AddProductConfigCombo : System.Web.UI.Page
    {
        ...
        protected void btn_Add_Click(object sender, EventArgs e)
        {
            ...
            if (ddl_config1.SelectedValue != "" && int.Parse(tb_quantity.Text) > 0 && double.Parse(tb_price.Text) > 0)
            {
                ...
                {
                    innerhtml += "<strong>" + (i + 1) + "</strong>. <strong>" + prodcc[i].Config1 + " " + prodcc[i].Config2 + " " + prodcc[i].Config3 + " " + prodcc[i].Config4 + "</strong> - <strong>Price:</strong> " + prodcc[i].Price + ". <strong>Quantity:</strong> " + prodcc[i].Quantity + "<br>";
                }
        ...
        protected void btn_clear_Click(object sender, EventArgs e)
        {
            ...
            Session["prodcc"] = new List<ProductConfigCombo>();
            status.InnerHtml = "";
        }
