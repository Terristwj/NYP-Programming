...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function generateRandomInput() {
            var sals = ["Mr. ", "Mrs. ", "Ms. ", "Mdm. ", "Ms. ", "Dr. "];

            var names = ["Goh", "Tan", "Lim", "Loo", "Tay", "Lok", "Kam", "Lee", "Ng"];

            var descs = ["I have an issue with my order. Can you help me?",
                        "My graphics card DOA. Can you look into this? Thank you.", "Is my order delayed?",
                        "I want to lodge a complaint against your rude staff.",
                        "I want to compliment a staff for going out of his way to help me carry my PC from the shop to the carpark.",
                        "When are you closed for Christmas?",
                        "How do I install my processor?",
                        "I received my order but it is missing some items. Can you help check what is going on?"
            ];

            document.getElementById("ddl_Sal").value = sals[getRandomInt(0, sals.length - 1)];

            document.getElementById("tb_Name").value = names[getRandomInt(0, names.length - 1)];

            document.getElementById("tb_issueDesc").value = descs[getRandomInt(0, descs.length - 1)];
        ...
        <div style="padding: 50px;">
            ...
            <div class="row col-md-12" style="margin-top: 30px; margin-bottom: 30px; text-align: center;">
                <div class="row" style="margin: auto;">
                    ...
                    <div style="padding: 5px">
                        <button id="btn_generate" type="button" class="btn btn-info" onclick="generateRandomInput()"><i class="fas fa-key"></i></button>
                    </div>
                </div>
            </div>
