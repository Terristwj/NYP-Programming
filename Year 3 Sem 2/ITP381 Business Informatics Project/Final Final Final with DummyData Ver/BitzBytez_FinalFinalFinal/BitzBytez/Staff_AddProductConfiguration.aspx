...
<%--            <div class="row col-md-12" style="margin: 0px;">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <div class="row col-md-12" style="margin: 0px;">
                        <div id="status" runat="server" class="col-md-10" style="padding: 10px; padding-top: 30px; font-size: 14px; margin: auto; text-align: center; color: darkgreen; letter-spacing: -1px;">
                        </div>
                    </div>
                </ContentTemplate>
            </asp:UpdatePanel>
