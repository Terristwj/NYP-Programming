    ...
    public partial class ProductDetails : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["productID"] != null)
            {
                ...
                id_productPrice.InnerHtml = "SGD " + p.BasePrice.ToString("N2");
        ...
        protected void addToCart(object sender, EventArgs e)
        {
            ...
            if (Session["selectedCombo"] != null)
            {
                combo = Session["selectedCombo"] as ProductConfigCombo;
            }
            ...
            if (cartID > 0)
            {
                ...
                {
                    ClientScript.RegisterStartupScript(GetType(), "hwa", "alert('Item not available')", true);
                }
            }
            else
            {
        ...
        protected void btn_getPrice_Click(object sender, EventArgs e)
        {
            ...
            if (combo != null)
            {
                ...
                id_productPrice.InnerHtml = "SGD " + combo.Price.ToString("N2");
                //div_addToCart.Visible = true;
            } else
            {
                Session["selectedCombo"] = null;
                id_productPrice.Style.Add("color", "red");
                id_productPrice.InnerHtml = "Unavailable";
                //div_addToCart.Visible = false;
            }
