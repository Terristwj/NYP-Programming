<%@ Page Title="" Language="C#" MasterPageFile="~/CustomerProfile.master" AutoEventWireup="true" CodeBehind="Cust_ChangePassword.aspx.cs" Inherits="BitzAndBytez.Cust_ChangePassword" %>
    ...
    <div class="upperContainer">
        <div class="formContent">
            ...
            <div class="formContent_row">
                ...
                <div class="div_input">
                    <asp:TextBox ID="tb_curPassword" runat="server" Width="250px"></asp:TextBox>
                </div>
            </div>
            <div class="formContent_row">
                <div class="div_label">
                ...
                <div class="div_input">
                    <asp:TextBox ID="tb_newPassword" runat="server" Width="250px"></asp:TextBox>
                </div>
            </div>
            <div ID="row_Password" runat="server" class="formContent_row">
                ...
                <div class="div_input">
                    <asp:TextBox ID="tb_conPassword" runat="server" Width="250px"></asp:TextBox>
                </div>
            </div>
