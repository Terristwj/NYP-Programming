            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <div class="formContent_row formContent_row3">
                        ...
                        <div class="div_input">
                            <asp:DropDownList ID="ddl_service" Height="30px" Width="250px" runat="server" OnSelectedIndexChanged="ddl_service_SelectedIndexChanged"  AutoPostBack="True">
                    ...
                    <div class="formContent_row formContent_row5">
                        ...
                        <div class="div_input">
                            <asp:DropDownList ID="ddl_time" Height="30px" Width="250px" runat="server">
                            </asp:DropDownList>
                        </div>
                    </div>
