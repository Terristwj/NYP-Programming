<%@ Page Title="" Language="C#" MasterPageFile="~/Staff_ServiceTransactions.master" AutoEventWireup="true" CodeBehind="Staff_ServiceTransactions_Transactions.aspx.cs" Inherits="BitzBytez.Staff_ServiceTransactions_Transactions" %>
                        ...
                        <ItemTemplate>
                            <div class="template_container">
                                ...
                                <div class="template_buttons">
                                    <asp:Button ID="btn_status" CssClass='<%# Eval("status").ToString().Equals("Delivered") ? "btn_deliever" : "btn_cancel" %>' runat="server" Text='<%# Eval("status") %>' Enabled="False" />
                                </div>
                            </div>
                        </ItemTemplate>
                    </asp:DataList>
