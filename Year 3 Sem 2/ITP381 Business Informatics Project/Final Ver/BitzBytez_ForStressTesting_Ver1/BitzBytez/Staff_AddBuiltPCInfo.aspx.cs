    ...
    public partial class Staff_AddBuiltPCWarrantyInfo : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["ComponentWarrantyDetails"] != null)
            {
                ...
                //ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Not empty')", true);
            }

            //ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Empty')", true);
        }
