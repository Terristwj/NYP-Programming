                ...
                <div class="sidebar left" style="min-height: 795px;">
                    <div class="user-panel">
                        <div class="pull-left image">
                            <img src="/img/CustDefaultPic.png" class="rounded-circle" alt="User Image" style="background:white;">
                        </div>
                        <div class="pull-left info">
                            <p>Welcome, </p>
                            <h4 style="letter-spacing:-1px;"><strong>Terris Tan</strong></h4>
                        </div>
                    </div>
                    <ul class="list-sidebar bg-defoult">
                        <li><a href="#" data-toggle="collapse" data-target="#dashboard" class="collapsed active"><i class="fa fa-history"></i><span class="nav-label">&emsp;History</span><span class="fa fa-chevron-left pull-right"></span></a>
                            <ul class="sub-menu collapse" id="dashboard">
                                ...
                                <li><a href="BookingHistory.aspx?service=PCBuilding">Bookings</a></li>
                            </ul>
                        </li>
...
<%--                        <li><a href="#"><i class="fa fa-laptop"></i><span class="nav-label">Grid options</span></a> </li>
                        ...
                        <li>
                            <asp:LinkButton ID="btn_viewBookings" runat="server" OnClick="btn_viewBookings_Click"><i class="fa fa-calendar-alt"></i><span class="nav-label">&emsp;Upcoming Bookings</span></asp:LinkButton>
                        </li>
                        <li>
