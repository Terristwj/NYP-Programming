<%@ Page Title="View Doctors" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewDoctors.aspx.cs" Inherits="ViewDoctors" %>
                ...
                <div class="topHeader">
                    <div class="searchContainer">
                        <div class="searchContainer1">
                            ...
                            <asp:TextBox ID="tb_SearchID" CssClass="tb_SearchID" runat="server"></asp:TextBox>
                            <asp:Button ID="btn_SearchID" CssClass="btn_SearchID" runat="server" Text="Search" OnClick="btn_SearchID_Click" />
                        </div>
                        <div class="searchContainer2"> 
                            <asp:Button ID="btn_Add" CssClass="btn_Add" runat="server" Text="Add Doctor" OnClick="btn_Add_Click" />
                    ...
                    <div class="sortContainer">
                        ...
                        <div class="sortContainer2">
                            ...
                            <asp:DropDownList ID="ddl_Sort" CssClass="ddl_Sort" runat="server">
                                <asp:ListItem>Doctor ID ASC</asp:ListItem>
                                <asp:ListItem>Doctor ID DESC</asp:ListItem>
                                <asp:ListItem>Name A-Z</asp:ListItem>
                                <asp:ListItem>Name Z-A</asp:ListItem>
                                <asp:ListItem>Consults ASC</asp:ListItem>
                                <asp:ListItem>Consults DESC</asp:ListItem>
                            </asp:DropDownList>
                ...
                <div class="GV_container">
                    <asp:GridView ID="gv_Products" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" CssClass="gv_Staff">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="consultsGiven" HeaderText="Total Consults" />
