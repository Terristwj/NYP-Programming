...
public partial class StoreFood : System.Web.UI.Page
{
    static string command = "SELECT * FROM Products WHERE Category = 'Food'";
    static string rewriteCommand = "SELECT * FROM Products WHERE Category = 'Food'";
