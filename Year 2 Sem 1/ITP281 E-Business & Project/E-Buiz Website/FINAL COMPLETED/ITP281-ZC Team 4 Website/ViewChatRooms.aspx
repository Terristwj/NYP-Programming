<%@ Page Title="View Chat Room" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewChatRooms.aspx.cs" Inherits="ViewChatRooms" %>
            ...
            <ContentTemplate>
                <div class="topHeader">
                    ...
                    <div class="searchContainer">
                        ...
                        <div class="searchContainer2"> 
                            <asp:Button ID="btn_Add" CssClass="btn_Add" runat="server" Text="Add Room" OnClick="btn_Add_Click" />
                            ...
                            <asp:TemplateField HeaderText="Controls">
                                <ItemTemplate>
                                    <div class="deleteContainer">
                                        <asp:Button ID="btn_Delete" CssClass="btn_Delete" runat="server" Text="Delete" CommandName="Delete" CommandArgument='<%# Eval("chatRoomID") %>' />
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
