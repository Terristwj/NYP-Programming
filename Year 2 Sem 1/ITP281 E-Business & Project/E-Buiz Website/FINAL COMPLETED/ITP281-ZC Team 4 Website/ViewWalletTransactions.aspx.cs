...
public partial class ViewWalletTransactions : System.Web.UI.Page
{
    ...
    {
        command = "SELECT * FROM EWalletTransactions ewt";
        command += " LEFT JOIN userAccounts ua ON ewt.userID = ua.userID";
        command += " WHERE ewt.userID IS NOT NULL";
        if (!IsPostBack)
        {
    ...
    protected void btn_SearchUserID_Click(object sender, EventArgs e)
    {
        ...
        {
            condition_Requirement = "AND ewt.userID = '" + value + "'";
        }
    ...
    protected void btn_Sort_Click(object sender, EventArgs e)
    {
        ...
        else if (value.Equals("User ID ASC"))
        {
            ViewGridView("ORDERBY", "ORDER BY ewt.userID ASC");
        }
        else if (value.Equals("User ID DESC"))
        {
            ViewGridView("ORDERBY", "ORDER BY ewt.userID DESC");
        }
    }
