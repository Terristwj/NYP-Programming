<%@ Page Title="View Store Transactions" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewStoreTransactions.aspx.cs" Inherits="ViewStoreTransactions" %>
                            ...
                            <asp:TemplateField HeaderText="Order ID" HeaderStyle-CssClass="Header1">
                                <ItemTemplate>
                                    <div class="columnLink">
                                        ...
                                        <asp:HyperLink ID="HyperLink1" runat="server" CssClass="hyperLink" NavigateUrl='<%# "ViewStoreReceipt2.aspx?login=true&staffID=" + Request.QueryString["staffID"] + "&orderID=" + Eval("Order_ID") %>'></asp:HyperLink>
                                    </div>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Total Price" HeaderStyle-CssClass="Header2" ItemStyle-CssClass="column">
                                <ItemTemplate>
                                    <div class="columnLink">
                                        ...
                                        <asp:HyperLink ID="HyperLink2" runat="server" CssClass="hyperLink" NavigateUrl='<%# "ViewStoreReceipt2.aspx?login=true&staffID=" + Request.QueryString["staffID"] + "&orderID=" + Eval("Order_ID") %>'></asp:HyperLink>
                                    </div>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Wallet Amount Used" HeaderStyle-CssClass="Header3" ItemStyle-CssClass="column">
                                <ItemTemplate>
                                    <div class="columnLink">
                                        ...
                                        <asp:HyperLink ID="HyperLink3" CssClass="hyperLink" runat="server" NavigateUrl='<%# "ViewStoreReceipt2.aspx?login=true&staffID=" + Request.QueryString["staffID"] + "&orderID=" + Eval("Order_ID") %>'></asp:HyperLink>
                                    </div>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Net Price" HeaderStyle-CssClass="Header4" ItemStyle-CssClass="column">
                                <ItemTemplate>
                                    <div class="columnLink">
                                        ...
                                        <asp:HyperLink ID="HyperLink4" CssClass="hyperLink" runat="server" NavigateUrl='<%# "ViewStoreReceipt2.aspx?login=true&staffID=" + Request.QueryString["staffID"] + "&orderID=" + Eval("Order_ID") %>'></asp:HyperLink>
                                    </div>
                                </ItemTemplate>
                                <ItemStyle CssClass="column" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Date Of Order" HeaderStyle-CssClass="Header5" ItemStyle-CssClass="column">
                                <ItemTemplate>
                                    <div class="columnLink2">
                                        ...
                                        <asp:HyperLink ID="HyperLink5" CssClass="hyperLink" runat="server" NavigateUrl='<%# "ViewStoreReceipt2.aspx?login=true&staffID=" + Request.QueryString["staffID"] + "&orderID=" + Eval("Order_ID") %>'></asp:HyperLink>
                                    </div>
                                </ItemTemplate>
                                <ItemStyle CssClass="column" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Delivery Date" HeaderStyle-CssClass="Header6" ItemStyle-CssClass="column">
                                <ItemTemplate>
                                    <div class="columnLink3">
                                        ...
                                        <asp:HyperLink ID="HyperLink6" CssClass="hyperLink" runat="server" NavigateUrl='<%# "ViewStoreReceipt2.aspx?login=true&staffID=" + Request.QueryString["staffID"] + "&orderID=" + Eval("Order_ID") %>'></asp:HyperLink>
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Delievery Address" HeaderStyle-CssClass="Header7" ItemStyle-CssClass="column">
                                <ItemTemplate>
                                    <div class="columnLink">
                                        ...
                                        <asp:HyperLink ID="HyperLink7" CssClass="hyperLink" runat="server" NavigateUrl='<%# "ViewStoreReceipt2.aspx?login=true&staffID=" + Request.QueryString["staffID"] + "&orderID=" + Eval("Order_ID") %>'></asp:HyperLink>
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Name" HeaderStyle-CssClass="Header1">
                                <ItemTemplate>
                                    <div class="columnLink">
                                        <asp:Label ID="lb_TransactionID" runat="server" Text='<%# Bind("name") %>'></asp:Label>
                                        <asp:HyperLink ID="HyperLink7" CssClass="hyperLink" runat="server" NavigateUrl='<%# "ViewStoreReceipt2.aspx?login=true&staffID=" + Request.QueryString["staffID"] + "&orderID=" + Eval("Order_ID") %>'></asp:HyperLink>
                                    </div>
                                </ItemTemplate>
                                <ItemStyle CssClass="column" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="User ID" HeaderStyle-CssClass="Header1">
                                <ItemTemplate>
                                    <div class="columnLink">
                                        <asp:Label ID="lb_TransactionID" runat="server" Text='<%# Bind("userID") %>'></asp:Label>
                                        <asp:HyperLink ID="HyperLink7" CssClass="hyperLink" runat="server" NavigateUrl='<%# "ViewStoreReceipt2.aspx?login=true&staffID=" + Request.QueryString["staffID"] + "&orderID=" + Eval("Order_ID") %>'></asp:HyperLink>
                                    </div>
                                </ItemTemplate>
                                <ItemStyle CssClass="column" />
