...
public partial class ProfilePageTransactionsDoctor : System.Web.UI.Page
{
    static string command = "";
    static string rewriteCommand = "";
    protected void Page_Load(object sender, EventArgs e)
    {
        command = "SELECT * FROM Booking WHERE userID='" + Request.QueryString["userID"] + "'";
    ...
    protected void gv_Products_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            string queryString = "?login=true" + "&userID=" + Request.QueryString["userID"] + "&bookingID=" + e.CommandArgument;
