<%@ Page Title="My Bookings" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewMyBookings.aspx.cs" Inherits="ViewMyBookings" %>
                ...
                <div class="GV_container">
                    <asp:GridView ID="gv_Products" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" CssClass="gv_Staff" OnRowCommand="gv_Products_RowCommand">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="roomPassword" HeaderText="Password" />

                            <asp:TemplateField HeaderText="Controls">
                                <ItemTemplate>
                                    <div class="deleteContainer">
                                        <asp:Button ID="btn_Delete" CssClass="btn_Delete" runat="server" Text="Revoke" CommandName="Revoke" CommandArgument='<%# Eval("bookingID") %>' />
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
