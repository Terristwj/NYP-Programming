<%@ Page Title="Doctor Bookings" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DoctorProfileBookings.aspx.cs" Inherits="DoctorProfileBookings" %>
                ...
                <div class="topHeader">
                    <div class="searchContainer">
                        ...
                        <div class="searchContainer2"> 
                            <asp:Button ID="btn_Create" CssClass="btn_Create" runat="server" Text="Create Booking" OnClick="btn_Create_Click" />
                    ...
                    <div class="searchContainer_2">
                        ...
                        <div class="searchContainer4">   
                            <label>Filter Status:</label>
                            <asp:DropDownList ID="ddl_Status" CssClass="ddl_Status" runat="server">
                                <asp:ListItem>None</asp:ListItem>
                                <asp:ListItem>Accepted</asp:ListItem>
                                <asp:ListItem>Null</asp:ListItem>
                            </asp:DropDownList>
                            <asp:Button ID="Button1" CssClass="btn_SearchDate" runat="server" Text="Filter" OnClick="btn_Filter_Click" />
                        </div>
                    </div>
                            ...
                            <asp:TemplateField HeaderText="Controls">
                                <ItemTemplate>
                                    <div class="deleteContainer">
                                        <asp:Button ID="btn_Delete" CssClass="btn_Delete" runat="server" Text="Delete" CommandName="Delete" CommandArgument='<%# Eval("bookingID") %>' />
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
