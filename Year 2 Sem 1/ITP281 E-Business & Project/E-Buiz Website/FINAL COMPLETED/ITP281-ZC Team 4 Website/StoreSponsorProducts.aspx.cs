...
public partial class StoreSponsorProducts : System.Web.UI.Page
{
    static string command = "SELECT * FROM Products WHERE Category = 'Sponsor Products'";
    static string rewriteCommand = "SELECT * FROM Products WHERE Category = 'Sponsor Products'";
