...
public partial class StoreMedicine : System.Web.UI.Page
{
    static string command = "SELECT * FROM Products WHERE Category = 'Medicine'";
    static string rewriteCommand = "SELECT * FROM Products WHERE Category = 'Medicine'";
