<%@ Page Title="Room View" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DoctorRoomView.aspx.cs" Inherits="DoctorRoomView" %>
                ...
                <div class="topHeader">
                    <div class="searchContainer">
                        ...
                        <div class="searchContainer2"> 
                            <asp:Button ID="btn_Refresh" CssClass="btn_SearchDate" runat="server" Text="Refresh Page" OnClick="btn_RefreshPage_Click" />
                        </div>
                    </div>
                ...
                <div class="GV_container">
                    <asp:GridView ID="gv_Products" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" CssClass="gv_Staff" OnRowCommand="gv_Products_RowCommand">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="bookedName" HeaderText="Booked By" />
                            ...
                            <asp:TemplateField HeaderText="Controls">
                                <ItemTemplate>
                                    <div class="deleteContainer">
                                        <asp:Button ID="btn_Delete" CssClass="btn_Delete" runat="server" Text="Join" CommandName="Join" CommandArgument='<%# Eval("roomID") %>' />
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
