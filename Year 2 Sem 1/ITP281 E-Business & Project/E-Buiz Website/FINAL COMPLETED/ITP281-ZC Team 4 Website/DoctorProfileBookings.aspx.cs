...
public partial class DoctorProfileBookings : System.Web.UI.Page
{
    ...
    protected void gv_Products_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Delete")
        {
            ...
            {
                conn.Close();
                queryString = "?login=true" + "&doctorID=" + Request.QueryString["doctorID"];
                Page.Response.Redirect("~/DoctorProfileBookings.aspx" + queryString + "&delete=fail", true);
            }
            ...
            //Refresh webpage
            queryString = "?login=true" + "&doctorID=" + Request.QueryString["doctorID"];
            Page.Response.Redirect("~/DoctorProfileBookings.aspx" + queryString, true);
        }
    }
