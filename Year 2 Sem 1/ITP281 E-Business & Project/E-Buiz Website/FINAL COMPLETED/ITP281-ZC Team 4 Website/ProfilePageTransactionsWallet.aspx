<%@ Page Title="Transactions" Language="C#" MasterPageFile="~/MasterTransactions.master" AutoEventWireup="true" CodeFile="ProfilePageTransactionsWallet.aspx.cs" Inherits="ProfilePageTransactionsWallet" %>
            ...
            <div class="topHeader">
                ...
                <div class="searchContainer_2">
                    <div class="sortContainer1">
                        ...
                        <asp:TextBox ID="tb_SearchDate" CssClass="tb_SearchDate" runat="server" PlaceHolder="DD/MM/YYYY"></asp:TextBox>
                ...
                <div class="searchContainer_3">
                    ...
                    <div class="sortContainer2">
                        ...
                        <asp:DropDownList ID="ddl_Sort" CssClass="ddl_Sort" runat="server">
                            ...
                            <asp:ListItem>Final Wallet ASC</asp:ListItem>
                            <asp:ListItem>Final Wallet DESC</asp:ListItem>
                        </asp:DropDownList>
            ...
            <div class="GV_container">
                <asp:GridView ID="gv_Products" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" CssClass="gv_Products">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Final Wallet" HeaderStyle-CssClass="Header5" ItemStyle-CssClass="column">
                            <ItemTemplate>
                                <div class="columnLink">
                                    <asp:Label ID="lb_FinalWallet" CssClass="lb_DateOfOrder" runat="server" Text='<%# Bind("finalWallet", "{0:n}") %>'></asp:Label>
                                </div>
                            </ItemTemplate>
                            <ItemStyle CssClass="column" />
                        </asp:TemplateField>
