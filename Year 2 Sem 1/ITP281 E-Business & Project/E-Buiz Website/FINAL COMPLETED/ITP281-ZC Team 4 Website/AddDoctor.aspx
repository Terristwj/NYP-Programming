<%@ Page Title="Add Doctor" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AddDoctor.aspx.cs" Inherits="AddDoctor" %>
        ...
        <div class="containerContent">
            ...
            <div class="creationContainer">
                ...
                <div class="nameContainer">
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" Cssclass="validator" runat="server" ErrorMessage="Max 20 characters" ForeColor="Red" ControlToValidate="tb_Name" Display="Dynamic" ValidationGroup="Create" ValidationExpression="^.{1,20}$"></asp:RegularExpressionValidator >
                </div>
            </div>
