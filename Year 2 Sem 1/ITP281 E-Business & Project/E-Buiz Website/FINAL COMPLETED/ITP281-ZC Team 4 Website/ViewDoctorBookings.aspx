<%@ Page Title="View Doctor Bookings" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewDoctorBookings.aspx.cs" Inherits="ViewDoctorBookings" %>
                ...
                <div class="GV_container">
                    <asp:GridView ID="gv_Products" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" CssClass="gv_Staff" OnRowCommand="gv_Products_RowCommand">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="accName" HeaderText="User's Name" />
