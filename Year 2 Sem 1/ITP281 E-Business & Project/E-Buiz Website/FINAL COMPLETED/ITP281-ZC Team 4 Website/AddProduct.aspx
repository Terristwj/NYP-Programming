<%@ Page Title="Add Product" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AddProduct.aspx.cs" Inherits="AddProduct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="extraDiv">
                ...
                <tr>
                    <td class="imageSpace">
                        <div id="img_Product_Container">
                            <asp:Image ID="img_Product" CssClass="img_Product" runat="server" ImageUrl="~/CSS and Images/Images and fonts/ImageHere.png" />
                        </div>
                    </td>
                    <td>
                        <div id="productContentContainer">
                            <div class="nameContainer" >
                                ...
                                <asp:TextBox ID="tb_Name" CssClass="tb_name" runat="server" PlaceHolder="Name" TextMode="MultiLine"></asp:TextBox>
                            </div>
                            <div class="stockContainer" style="text-align:center;margin-bottom:-15px;">
                                <div class="stockContainer1">
                                    <label>Stock: </label>
                                    <asp:TextBox ID="tb_Stock" CssClass="textbox tb_Stock" runat="server" PlaceHolder="0"></asp:TextBox>
                                    <div class="validator">
                            ...
                            <div class="addContainer" style="text-align:center;">
                                <div class="addContainer1">
                                    <label>Price: $</label>
                                    <asp:TextBox ID="tb_Price" CssClass="textbox tb_Price" runat="server" PlaceHolder="0.00" ></asp:TextBox>
                            ...
                            <div class="descriptionContainer">
                                <asp:TextBox ID="tb_Desc" CssClass="labels tb_label" runat="server" PlaceHolder="Description (Optional)" TextMode="MultiLine"></asp:TextBox>
                            </div>
                        </div>
                    </td>
                </tr>
        ...
        <div class="contentFooter">
            ...
            <div  style="float:right">
                <asp:Button ID="btn_Add2" CssClass="btnLabels btnLabels2" runat="server" Text="Add" OnClick="btn_Add_Click" ValidationGroup="Update" />
