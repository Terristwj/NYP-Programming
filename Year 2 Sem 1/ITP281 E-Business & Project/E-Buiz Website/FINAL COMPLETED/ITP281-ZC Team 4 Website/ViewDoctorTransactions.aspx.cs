...
public partial class ViewDoctorTransactions : System.Web.UI.Page
{
    ...
    protected void btn_SearchUserID_Click(object sender, EventArgs e)
    {
        ...
        {
            condition_Requirement = "AND b.userID = '" + value + "'";
        }
        ViewGridView("Search", condition_Requirement);
    }

    protected void btn_SearchDoctorID_Click(object sender, EventArgs e)
    {
        string value = tb_SearchDoctorID.Text;
        tb_SearchDate.Text = "";
        tb_SearchTime.Text = "";
        tb_Search.Text = "";
        tb_SearchUserID.Text = "";
        ...
        {
            condition_Requirement = "AND b.Doctor_ID = '" + value + "'";
        }
        ViewGridView("Search", condition_Requirement);
    }
    ...
    protected void gv_Products_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            string queryString = "?login=true" + "&staffID=" + Request.QueryString["staffID"] + "&bookingID=" + e.CommandArgument;
