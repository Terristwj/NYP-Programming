<%@ Page Title="Booking View" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DoctorBookingView.aspx.cs" Inherits="DoctorBookingView" %>
                ...
                <div class="topHeader">
                    <div class="searchContainer">
                        ...
                        <div class="searchContainer2"> 
                            <asp:Button ID="btn_Create" CssClass="btn_Create" runat="server" Text="View My Bookings" OnClick="btn_ViewBookings_Click" />
                            ...
                            <asp:TemplateField HeaderText="Controls">
                                <ItemTemplate>
                                    <div class="deleteContainer">
                                        <asp:Button ID="btn_Delete" CssClass="btn_Delete" runat="server" Text="Select" CommandName="Select" CommandArgument='<%# Eval("bookingID") %>' />
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
